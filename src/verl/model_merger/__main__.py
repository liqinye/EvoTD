...
"""
This module is used to merge Hugging Face models and test VERL checkpoints from the FSDP backend.
...
Megatron backend support has been removed.
"""
...
def main():
    ...
    if config.backend == "fsdp":
        ...
        raise NotImplementedError("Megatron backend is no longer supported.")
    else:
