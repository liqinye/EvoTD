...
__all__ = ["PolicyLossConfig", "ActorConfig", "FSDPActorConfig"]
...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        log_entropy (bool): Whether to compute/log entropy even when entropy_coeff is zero.
